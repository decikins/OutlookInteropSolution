...
using OutlookInterop.HTMLHandling;


namespace OutlookInterop {
    public static class OutlookHandling {
    ...
    //MAIN SEQUENCE ORDER FILING
        ...
        public static void ParseOrders(string folderPath) {
            ParseOrders(_GetFolderSwitch(folderPath).Items);
        }
        public static void ParseOrders(Folder folder) {
            ParseOrders(folder.Items);
        }
        public static void ParseOrders(Items items) {
            ProgressBar pbar = new ProgressBar();
            pbar.Report(0);
    ...
    //TESTING SCENARIO
        public static bool SetupDefaultTest(int maxItems, string sourceItemFilter=null) {
            return _SetupTestEnvironment(DeletedItems, RootFolder, _testFolderName, maxItems, sourceItemFilter);
        }
        public static void StopTestEnvironment() {
    ...
    static class OrderTypeInfo {
        public static readonly List<string> WufooSenders = Properties.Settings.Default.WufooSenders.Cast<string>().ToList<string>();
        public static readonly string WufooSenderEmail = "no-reply@wufoo.com";
        public static readonly string MagentoSenderEmail = (string)Properties.Settings.Default.MagentoSenderEmail;
